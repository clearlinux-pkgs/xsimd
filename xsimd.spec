...
Source0  : https://github.com/xtensor-stack/xsimd/archive/13.2.0/xsimd-13.2.0.tar.gz
...
%prep
%setup -q -n xsimd-13.2.0
cd %{_builddir}/xsimd-13.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740508201
mkdir -p clr-build
pushd clr-build
