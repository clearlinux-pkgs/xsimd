...
Source0  : https://github.com/xtensor-stack/xsimd/archive/13.1.0/xsimd-13.1.0.tar.gz
Summary  : xsimd provides a unified means for using SIMD features for library authors..
Group    : Development/Tools
License  : BSD-3-Clause
Requires: xsimd-data = %{version}-%{release}
...
%package data
Summary: data components for the xsimd package.
Group: Data

%description data
data components for the xsimd package.
...
%prep
%setup -q -n xsimd-13.1.0
cd %{_builddir}/xsimd-13.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733821570
mkdir -p clr-build
pushd clr-build
